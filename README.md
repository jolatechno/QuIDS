...
The code is documented using `doxygen`. Documentation is present at [doc/](./doc/) and is also hosted at [jolatechno.github.io/QuIDS/](https://jolatechno.github.io/QuIDS/).
